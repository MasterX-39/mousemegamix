...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'street1': //Suicide Mouse Week 1
				var bg:BGSprite = new BGSprite('street1', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'street-mikugod': //Suicide Mouse Week 1
			    GameOverSubstate.deathSoundName = 'fnf_loss_sfx';
				GameOverSubstate.loopSoundName = 'gameOver-miku';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'ladesapariciondehatsunemiku';
				var bg:BGSprite = new BGSprite('street1', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'street2': //Suicide Mouse Week 1
				var bg:BGSprite = new BGSprite('street2', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'street3': //Suicide Mouse Week 1
				var bg:BGSprite = new BGSprite('street3', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'streetalt': //Suicide Mouse Week 1 unused bg
				var bg:BGSprite = new BGSprite('streetalt', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'suicidebackground': //Suicide Mouse Week Final
			    GameOverSubstate.deathSoundName = 'fnf_loss_sfx';
				GameOverSubstate.loopSoundName = 'gameOver-final';
				GameOverSubstate.endSoundName = 'gameOverEnd-final';
				GameOverSubstate.characterName = 'bfsuicide';

				var bg:BGSprite = new BGSprite('haha', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'originalbackground': //Suicide Mouse Week Final
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx';
				GameOverSubstate.loopSoundName = 'gameOver-final';
				GameOverSubstate.endSoundName = 'gameOverEnd-final';
				GameOverSubstate.characterName = 'bf-final';

				var bg:BGSprite = new BGSprite('lmao', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'streetneo': //Suicide Mouse NEO Week
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx';
				GameOverSubstate.loopSoundName = 'gameOver-neo';
				GameOverSubstate.endSoundName = 'gameOverEnd-neo';
				GameOverSubstate.characterName = 'bf-neo';

				var bg:BGSprite = new BGSprite('streetneo', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'soft': //Suicide Mouse SOFT Week
			    GameOverSubstate.deathSoundName = 'soft-loss';
				GameOverSubstate.loopSoundName = 'DeathMenu_Soft';
				GameOverSubstate.endSoundName = 'deathConfirm-Soft';
				GameOverSubstate.characterName = 'bf-soft';
				
				var bg:BGSprite = new BGSprite('proyectorplace', -600, -200, 0.9, 0.9);
				add(bg);
				
			case 'corrupt1': //Suicide Mouse Shitty Corrupt Week
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx';
				GameOverSubstate.loopSoundName = 'gameOver';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'bf';

				var bg:BGSprite = new BGSprite('corrupt1', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'corrupt2': //Suicide Mouse Shitty Corrupt Week
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx_oswald';
				GameOverSubstate.loopSoundName = 'gameOver-og';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'oswald-player2';

				var bg:BGSprite = new BGSprite('stageback-cor', -600, -200, 0.9, 0.9);
				add(bg);
				
				var stageFront:BGSprite = new BGSprite('stagefront-cor', -650, 600, 0.9, 0.9);
				stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
				stageFront.updateHitbox();
				add(stageFront);
				
				if(!ClientPrefs.lowQuality) {
					var stageLight:BGSprite = new BGSprite('stage_light-cor', -125, -100, 0.9, 0.9);
					stageLight.setGraphicSize(Std.int(stageLight.width * 1.1));
					stageLight.updateHitbox();
					add(stageLight);
					var stageLight:BGSprite = new BGSprite('stage_light-cor', 1225, -100, 0.9, 0.9);
					stageLight.setGraphicSize(Std.int(stageLight.width * 1.1));
					stageLight.updateHitbox();
					stageLight.flipX = true;
					add(stageLight);

					var stageCurtains:BGSprite = new BGSprite('stagecurtains-cor', -500, -300, 1.3, 1.3);
					stageCurtains.setGraphicSize(Std.int(stageCurtains.width * 0.9));
					stageCurtains.updateHitbox();
					add(stageCurtains);
				}
				
			case 'corrupt3': //Suicide Mouse Shitty Corrupt Week
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx';
				GameOverSubstate.loopSoundName = 'gameOver';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'bf';

				var bg:BGSprite = new BGSprite('corrupt2', -600, -300, 0.9, 0.9);
				add(bg);
				
			case 'vecindario': //Wednesday Infidelity
			    GameOverSubstate.characterName = 'bf-retro';
				var bg:BGSprite = new BGSprite('VecindarioBG', -600, -195, 0.9, 0.9);
				add(bg);
				
			case 'bobux': //Wednesday Infidelity pero destruido jiijiJA
			    GameOverSubstate.characterName = 'bf-retro';
				var bg:BGSprite = new BGSprite('Destruido', -600, -195, 0.9, 0.9);
				add(bg);
		
			case 'staticStage': //si funciona
			introSoundsSuffix = '-ci';
			GameOverSubstate.loopSoundName = 'gameOver-og';
			GameOverSubstate.endSoundName = 'gameOverEnd';
			
			case 'darkStaticStage': //si funciona
			introSoundsSuffix = '-ci';
			GameOverSubstate.loopSoundName = 'gameOver-og';
			GameOverSubstate.endSoundName = 'gameOverEnd';
			...
			case 'house': //Vs Mouse
			    GameOverSubstate.loopSoundName = 'gameOver-og';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'bf-normal';
				
			case 'disney': //Vs Mouse
			    GameOverSubstate.loopSoundName = 'gameOver-og';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'bf-normal';
				
			case 'suicide': //Vs Mouse
			    GameOverSubstate.loopSoundName = 'gameOver-og';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'bf-normal';
			...
			case 'street': //Crisis
			    GameOverSubstate.loopSoundName = 'gameOver-og';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'minnie-dead';
				
				var bg:BGSprite = new BGSprite('MouseBackgroundBeta', -1600, -180);
				add(bg);
				
			case 'cuphed': //El double down Xddddd
			    GameOverSubstate.loopSoundName = 'gameOver-og';
				GameOverSubstate.endSoundName = 'gameOverEnd';
				GameOverSubstate.characterName = 'minnie-dead';
				
				var bg:BGSprite = new BGSprite('cupheadbg', 0, 0);
				add(bg);
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'really-unhappy':
					startVideo('nooneknows');
					
				case 'suicide':
					startVideo('psych');
					
				case 'corrupted-unhappy':
					startVideo('corrup1');
					
				case 'corrupted-happy':
					startVideo('corrup2');
					
				case 'a-fate-worse-than-death':
					startVideo('corrup3');
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
			{
				...
				introAssets.set('streetneo', ['neo/feel', 'neo/the', 'neo/beat']);
				introAssets.set('corrupt1', ['cor/ready-cor', 'cor/set-cor', 'cor/go-cor']);
				introAssets.set('corrupt2', ['cor/ready-cor', 'cor/set-cor', 'cor/go-cor']);
				introAssets.set('corrupt3', ['cor/ready-cor', 'cor/set-cor', 'cor/go-cor']);
				introAssets.set('vecindario', ['wi/ready-wi', 'wi/set-wi', 'wi/go-wi']);
				introAssets.set('bobux', ['wi/ready-wi', 'wi/set-wi', 'wi/go-wi']);
				introAssets.set('staticStage', ['ci/ready-ci', 'ci/set-ci', 'ci/go-ci']);
				introAssets.set('darkStaticStage', ['ci/ready-ci', 'ci/set-ci', 'ci/go-ci']);
				introAssets.set('house', ['normal/ready', 'normal/set', 'normal/go']);
				introAssets.set('disney', ['normal/ready', 'normal/set', 'normal/go']);
				introAssets.set('suicide', ['normal/ready', 'normal/set', 'normal/go']);
				introAssets.set('red', ['normal/ready', 'normal/set', 'normal/go']);
				introAssets.set('black', ['normal/ready', 'ci/set', 'ci/go']);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingString == '?') {
			scoreTxt.text = 'Score: ' + songScore + ' | Port By MarioMaster | Misses: ' + songMisses + ' | Rating: ' + ratingString;
		} else {
			scoreTxt.text = 'Score: ' + songScore + ' | Port By MarioMaster | Misses: ' + songMisses + ' | Rating: ' + ratingString + ' (' + Math.floor(ratingPercent * 100) + '%)' + ' - ' + ratingFC;
		}
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_pass', 'week2_pass', 'week3_pass', 'week4_pass',
				'week5_pass', 'week6_pass', 'week7_pass', 'ci1_pass',
				'ci2_pass', 'mouse1_pass', 'mouse2_pass', 'mouse3_pass', 
                'crisis_pass', 'overjoy_pass', 'ur_bad',
				'ur_good', 'hype', 'two_keys', 'toastie', 'miku']);
	...
	function noteMiss(daNote:Note):Void { //You didn't hit the key and let it go offscreen, also used by Hurt Notes
		...
		if(daNote.noteType == 'Speed Note') {
			songSpeed += daNote.speed;
			health += 0.20;
			}
	...
	private function checkForAchievement(achievesToCheck:Array<String>):String {
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName)) {
				...
				{
					case 'week1_pass' | 'week2_pass' | 'week3_pass' | 'week4_pass' | 'week5_pass' | 'week6_pass' | 'week7_pass' | 'ci1_pass' | 'ci2_pass' | 'mouse1_pass' | 'mouse2_pass' | 'mouse3_pass' | 'crisis_pass':
						if(isStoryMode && CoolUtil.difficultyString() == 'HARD' && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							{
								case 'week1':
									if(achievementName == 'week1_pass') unlock = true;
								case 'week2':
									if(achievementName == 'week2_pass') unlock = true;
								case 'week3':
									if(achievementName == 'week3_pass') unlock = true;
								case 'week4':
									if(achievementName == 'week4_pass') unlock = true;
								case 'week5':
									if(achievementName == 'week5_pass') unlock = true;
								case 'week6':
									if(achievementName == 'week6_pass') unlock = true;
								case 'week7':
									if(achievementName == 'week7_pass') unlock = true;
								case 'weekci1':
									if(achievementName == 'ci1_pass') unlock = true;
								case 'weekci2':
									if(achievementName == 'ci2_pass') unlock = true;
								case 'mouse1':
									if(achievementName == 'mouse1_pass') unlock = true;
								case 'mouse2':
									if(achievementName == 'mouse2_pass') unlock = true;
								case 'mouse3':
									if(achievementName == 'mouse3_pass') unlock = true;
								case 'weekcrisis':
									if(achievementName == 'crisis_pass') unlock = true;
							}
						}
					case 'ur_bad':
					...
					case 'miku':
						if(Paths.formatToSongPath(SONG.song) == 'sister' && !usedPractice) {
							unlock = true;
						}
					case 'overjoy_pass':
						if(Paths.formatToSongPath(SONG.song) == 'souless-overjoy' && CoolUtil.difficultyString() == 'HARD' && !changedDifficulty && !usedPractice) {
							unlock = true;
						}
				}
